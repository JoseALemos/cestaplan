...
def upgrade() -> None:
    ...
    sa.Column('expected_provenance_document_hash', sa.Text(), nullable=True),
    sa.Column('observed_provenance_document_hash', sa.Text(), nullable=True),
    ...
    sa.Column('backup_storage_reference_hash', sa.Text(), nullable=True),
